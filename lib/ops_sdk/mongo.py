...
try:
    ...
    MongoConfig = dict(host=config.MONGO_HOST, port=27017, db_name=config.MONGO_DB_NAME, username=None, password=None)
except:
    MongoConfig = dict(host='127.0.0.1', port=27017, db_name='ngx_modsec', username=None, password=None)
